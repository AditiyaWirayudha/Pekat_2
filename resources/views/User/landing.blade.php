            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href=""
                                style="">{{ Auth::guard('masyarakat')->user()->nama }}</a>
                        </li>
                        <li class="nav-item">
...
<div class="row justify-content-center" style="background-color: 	#708090;">
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">Aditiya Wirayudha</p>
    </div>
</div>
{{-- Modal --}}
